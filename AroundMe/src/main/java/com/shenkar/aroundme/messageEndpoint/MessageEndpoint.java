 ...
 * on 2015-03-21 at 20:46:50 UTC 
 * Modify at your own risk.
 */

package com.shenkar.aroundme.messageEndpoint;
...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListMessages extends MessageEndpointRequest<com.shenkar.aroundme.messageEndpoint.model.CollectionResponseMessageData> {
    ...
    protected ListMessages() {
      super(MessageEndpoint.this, "GET", REST_PATH, null, com.shenkar.aroundme.messageEndpoint.model.CollectionResponseMessageData.class);
    }
    ...
    @Override
    public ListMessages setAlt(String alt) {
      return (ListMessages) super.setAlt(alt);
    }

    @Override
    public ListMessages setFields(String fields) {
      return (ListMessages) super.setFields(fields);
    }

    @Override
    public ListMessages setKey(String key) {
      return (ListMessages) super.setKey(key);
    }

    @Override
    public ListMessages setOauthToken(String oauthToken) {
      return (ListMessages) super.setOauthToken(oauthToken);
    }

    @Override
    public ListMessages setPrettyPrint(Boolean prettyPrint) {
      return (ListMessages) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ListMessages setQuotaUser(String quotaUser) {
      return (ListMessages) super.setQuotaUser(quotaUser);
    }

    @Override
    public ListMessages setUserIp(String userIp) {
    ...
    public ListMessages setCursor(String cursor) {
      this.cursor = cursor;
      return this;
    }
    ...
    public ListMessages setLimit(Integer limit) {
      this.limit = limit;
      return this;
    }
